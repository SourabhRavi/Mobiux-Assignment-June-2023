<template>
    <div class="scroll-wrap">
        <div class="bg-white backdrop-blur bg-opacity-90 p-5 rounded-xl lg:w-full w-max">
            <div class="section-heading capitalize 2xl:text-2xl text-xl font-bold text-cyan-950 2xl:mb-5 mb-3">2. Identify the SKU with the highest total sales quantity.</div>
            <div class="mb-8">
                ...
                <template v-for="(item, index) in sortedGetTotalRevenue" :key="index">
